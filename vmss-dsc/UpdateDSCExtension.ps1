...
Remove-AzureRmVmssExtension -VirtualMachineScaleSet $vmss -Name "updateddscdomainjoin"

# Update VMSS
Update-AzureRmVmss -ResourceGroupName $vmssRg -VMScaleSetName $vmssName -VirtualMachineScaleSet $vmss

# Add extension
Add-AzureRmVmssExtension -VirtualMachineScaleSet $vmss -Name "update2dscwebconfig" -Publisher "Microsoft.Powershell" -Type "DSC" -TypeHandlerVersion "2.76" -AutoUpgradeMinorVersion $True -Setting $settings -ProtectedSetting $protectedSettings
